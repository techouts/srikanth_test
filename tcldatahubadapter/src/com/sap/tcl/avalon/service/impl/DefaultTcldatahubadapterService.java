...
public class DefaultTcldatahubadapterService implements TcldatahubadapterService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTcldatahubadapterService.class);
	...
	{
		return DefaultTcldatahubadapterService.class.getResourceAsStream("/tcldatahubadapter/sap-hybris-platform.png");
	}
