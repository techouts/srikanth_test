 ...
 */
package com.sap.tcl.avalon.jalo;
...
/**
 * This is the extension manager of the Tcldatahubadapter extension.
 */
public class TcldatahubadapterManager extends GeneratedTcldatahubadapterManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(TcldatahubadapterManager.class);
	 ...
	 */
	public static TcldatahubadapterManager getInstance()
	{
		return (TcldatahubadapterManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TcldatahubadapterConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TcldatahubadapterManager() // NOPMD 
	{
		LOG.debug("constructor of TcldatahubadapterManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of TcldatahubadapterManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of TcldatahubadapterManager called, current tenant: {}", getTenant().getTenantID());
	}
